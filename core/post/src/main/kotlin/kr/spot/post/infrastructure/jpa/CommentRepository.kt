...
interface CommentRepository : JpaRepository<kr.spot.post.domain.Comment, Long> {
    @Query(
    ...
    ): List<kr.spot.post.domain.Comment>
...
fun kr.spot.post.infrastructure.jpa.CommentRepository.getByIdOrThrow(id: Long): kr.spot.post.domain.Comment =
